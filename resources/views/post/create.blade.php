            ...
            <div class="col-12">
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.post.create',$cover->id) }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="" maxlength="200" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-primary" href="{{ route('admin.post.index',$cover->id) }}">Atras</a>
                                    </div>
                                </div>
                            </div>
                        </form>
