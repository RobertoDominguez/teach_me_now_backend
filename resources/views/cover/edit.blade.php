            ...
            <div class="col-12">
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.cover.update',$cover->id) }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="content" rows="20">{{$cover->content}}</textarea>
                                    </div>
                                </div>
