...
@section('content')
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title">Agregar Facultad</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Sigla:</strong>
                            <input type="text" name="acronym" value="{{ $school->acronym }}" maxlength="12"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $school->name }}" maxlength="120"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" rows="10" maxlength="250">
                                {{ $school->description }}
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <img class="img-thumbnail mt-4" src="{{ asset('/storage/' . $school->image) }}"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <a class="btn btn-primary" href="{{ route('school.index') }}">Atras</a>
                        </div>
                    </div>
                </div>
            </form>
