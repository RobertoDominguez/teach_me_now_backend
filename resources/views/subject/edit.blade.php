...
@section('content')
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title">Agregar Materia</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Sigla:</strong>
                            <input type="text" name="acronym" value="{{ $subject->acronym }}" maxlength="12"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $subject->name }}" maxlength="120"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <a class="btn btn-primary" href="{{ route('subject.index') }}">Atras</a>
                        </div>
                    </div>
                </div>
            </form>
